...
export default function NotFoundPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#0F1117] dark:bg-[#0F1117] bg-[#F8F6F0]">
      {/* ===== Фоновый шум ===== */}
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-20 dark:opacity-10">
        ...
        >
          {/* Сетка улиц */}
          <g stroke="currentColor" strokeWidth="1" className="text-gray-400 dark:text-gray-600" opacity="0.6">
          ...
          {/* Кварталы (здания) */}
          <g className="text-gray-300 dark:text-gray-700" fill="currentColor" opacity="0.4">
          ...
          {/* Парк (зелёная зона) */}
          <g className="text-green-300 dark:text-green-900" fill="currentColor" opacity="0.3">
          ...
          {/* Названия улиц */}
          <g className="text-[8px] text-gray-400 dark:text-gray-500" fill="currentColor" opacity="0.5">
          ...
          {/* Стрелка компаса */}
          <g transform="translate(700, 80)" className="text-gray-400 dark:text-gray-600" fill="currentColor" opacity="0.4">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-background/30 to-background/80 dark:via-[#0F1117]/30 dark:to-[#0F1117]/80" />
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center">
        ...
        <div className="relative mb-6">
          <h1 className="text-[120px] md:text-[180px] font-bold leading-none tracking-tighter
            bg-gradient-to-b from-primary/30 to-primary/10 dark:from-primary/20 dark:to-transparent
        ...
        <div className="relative mb-8">
          ...
          <div className="w-4 h-4 rounded-full bg-primary relative z-10 shadow-lg shadow-primary/50" />
        </div>

        {/* Текст */}
        <p className="text-lg md:text-xl text-text-secondary mb-2 max-w-md">
          Кажется, этой улицы не существует...
        </p>
        <p className="text-base text-text-muted mb-10 max-w-md">
        ...
        <div className={`mb-10 transition-opacity duration-700 ${mounted ? 'opacity-100' : 'opacity-0'}`}>
          <svg
            viewBox="0 0 100 100"
            className="w-16 h-16 md:w-20 md:h-20 text-text-muted/40 dark:text-text-muted/20"
            style={{
          ...
          >
            ...
            {/* Стрелка севера */}
            <polygon
              points="50,10 54,45 50,40 46,45"
              fill="currentColor"
              opacity="0.6"
            />
            {/* Стрелка юга */}
            <polygon
              points="50,90 54,55 50,60 46,55"
              fill="currentColor"
              opacity="0.3"
            />
            {/* Центральная точка */}
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Link
            href="/"
            className="inline-flex items-center gap-2 px-6 py-3 bg-primary hover:bg-primary-hover text-white font-medium rounded-xl transition-all duration-200 shadow-lg shadow-primary/20 hover:shadow-primary/30"
          >
            <span>🧭</span>
          ...
          <Link
            href="/games"
            className="inline-flex items-center gap-2 px-6 py-3 bg-surface hover:bg-surface-elevated text-text-primary font-medium rounded-xl border border-border transition-all duration-200"
          >
            <span>📜</span>
