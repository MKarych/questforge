...
import { SessionState, TeamStatus } from '../../../src/engine/types/engine.types';

describe('TextMissionPlugin', () => {
  let plugin: TextMissionPlugin;
  let mockContext: ExecutionContextImpl;

  beforeEach(() => {
    plugin = new TextMissionPlugin();
    ...
    mockContext = new ExecutionContextImpl(mockState, '');
  });
