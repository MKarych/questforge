...
Способы запуска зависят от вашей операционной системы:

| ОС | Способ | Файл |
|----|--------|------|
| **Windows** | 🖥️ Скрипт (рекомендуется) | [`scripts/start.bat`](../scripts/start.bat) |
| **macOS / Linux** | 🖥️ Скрипт (рекомендуется) | [`scripts/start.sh`](../scripts/start.sh) |
| **Любая ОС** | 📝 Ручной запуск | [`SETUP.md`](./SETUP.md) |

**Что делают скрипты (`start.bat` / `start.sh`):**
- ✅ Автоматически поднимают Docker (PostgreSQL, Redis, MinIO)
- ✅ Устанавливают npm-зависимости
- ✅ Применяют Prisma-миграции и заполняют БД тестовыми данными
- ✅ Запускают API (порт 3000) и Frontend (порт 3001)
- ✅ Показывают IP-адрес для доступа с телефона по Wi-Fi
...
| Файл | Описание |
|------|----------|
| [`56-auth-module-spec.md`](./56-auth-module-spec.md) | Аутентификация: JWT, login/register, refresh, верификация |

### 👥 Социальный слой

| Файл | Описание |
|------|----------|
| [`62-social-module-spec.md`](./62-social-module-spec.md) | Друзья, заявки, личные чаты, блокировка, подписки |

### 💰 Billing и финансы

| Файл | Описание |
|------|----------|
| [`64-billing-module-spec.md`](./64-billing-module-spec.md) | Тарифы, лимиты, платежи, бухгалтерская книга |

### 🛒 Commerce (Маркетплейс)

| Файл | Описание |
|------|----------|
| [`61-commerce-module-spec.md`](./61-commerce-module-spec.md) | Маркетплейс, лицензирование, выплаты, аналитика |

### 🔔 Уведомления

| Файл | Описание |
|------|----------|
| [`65-notifications-module-spec.md`](./65-notifications-module-spec.md) | Система уведомлений: типы, доставка, WebSocket |

### 🏆 Достижения

| Файл | Описание |
|------|----------|
| [`66-achievements-module-spec.md`](./66-achievements-module-spec.md) | Система достижений: типы, условия, прогресс |

### 🔍 Поиск

| Файл | Описание |
|------|----------|
| [`67-search-module-spec.md`](./67-search-module-spec.md) | Глобальный поиск: игры, сценарии, пользователи, команды |

### 📊 Лента активности

| Файл | Описание |
|------|----------|
| [`68-activity-feed-module-spec.md`](./68-activity-feed-module-spec.md) | Лента действий пользователей, глобальная лента |

### 🎫 Поддержка

| Файл | Описание |
|------|----------|
| [`63-support-module-spec.md`](./63-support-module-spec.md) | Тикеты поддержки: создание, обработка, статистика |
...
| Файл | Описание |
|------|----------|
| [`SETUP.md`](./SETUP.md) | Пошаговая инструкция по установке и запуску (MacOS, Windows) |

### 🖥️ Скрипты запуска

| Файл | Описание |
|------|----------|
| [`../scripts/start.bat`](../scripts/start.bat) | Запуск всего стека на Windows (Docker + миграции + API + Frontend) |
| [`../scripts/start.sh`](../scripts/start.sh) | Запуск всего стека на macOS/Linux (с цветным выводом) |
