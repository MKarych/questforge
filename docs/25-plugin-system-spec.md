```markdown
# Plugin System Specification: Механики как плагины
...
- Каждая механика — это плагин
- Плагин регистрируется в движке
- Плагин имеет четкий интерфейс
- Плагины можно добавлять без переписывания ядра
